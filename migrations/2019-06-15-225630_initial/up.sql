...
CREATE TABLE movements (
    id SERIAL PRIMARY KEY,
    sender_player_id INTEGER REFERENCES players(id) NOT NULL,
    receiver_player_id INTEGER REFERENCES players(id) NOT NULL,
    sender_planet_id INTEGER REFERENCES planets(id) NOT NULL,
    receiver_planet_id INTEGER REFERENCES planets(id) NOT NULL,
    ships VARCHAR NOT NULL,
    resources VARCHAR NOT NULL,
    speed INTEGER NOT NULl,
    intention INTEGER NOT NULL, -- 0: friendly 1: depot 2: attack
